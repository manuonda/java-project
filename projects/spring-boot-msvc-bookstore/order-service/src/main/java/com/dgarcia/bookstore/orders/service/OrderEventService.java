...
import com.dgarcia.bookstore.orders.config.OrderEventPublisher;
...
import com.dgarcia.bookstore.orders.repository.OrderEventRepository;
...
public class OrderEventService {
    ...
    void save(OrderCreatedEvent event) {
        log.info("Save order event created {} ", toJsonPayload(event));
    ...
    void save(OrderDeliveredEvent event) {
        log.info("Save order delivered event");
        OrderEventEntity orderEvent = new OrderEventEntity();
        orderEvent.setEventId(event.eventId());
